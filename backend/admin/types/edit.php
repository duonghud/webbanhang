        ...
        <form method="post" action="update.php" class="bg-white p-4 rounded shadow-sm">
            <?php foreach ($types as $types) { ?>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="id" id="id" readonly value="<?php echo $types['id']; ?>">
                </div>
                <div class="mb-3">
                    <label for="name" class="form-label">Tên thương hiệu:</label>
                    <input type="text" class="form-control" name="name" id="name" value="<?php echo $types['name']; ?>">
                </div>
            <?php } ?>
